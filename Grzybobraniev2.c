...
int game(circle* circles, int id)
{
    ...
    while (1) {
        ...
        usleep(5000);
		if(circles[id].endGame == true && id == (circles[1].turnNumber % 3) + 1)
		{
        ...
        if (XPending(mydisplay) > 0) {
            ...
            case KeyPress:
                ...
                //STRZALKA W PRAWO
                if (myevent.xkey.keycode == 0x72 && id == (circles[1].turnNumber % 3) + 1) {
                    XSetForeground(mydisplay, mygc, mycolor.pixel);
                    ...
                    if (circles[id].visited[circles[id].place] > 0 && circles[id].place < 13) {
